...
public class App {
    public static void main(String[] args) throws IOException {
        ...
        var csvPath = Paths.get("/Users/andreweeckman/Downloads/hw3starter/data/github_issues.csv");
        ...
        System.out.println(GitHubProc.getWordCount(Util.readComments(csvPath), "The"));
